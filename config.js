const nameGirl = 'Bạn';
const giftUrl = 'https://www.facebook.com/nguyen.quochy.73';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng bạn tui';
const contentCard = 'Ngày 20/10, chúc bạn của tui: Hãy ăn chóng béo; Tiền nhiều như kẹo; Tình chặt như keo; Dẻo dai như mèo; Mịn màng trắng trẻo; Sức khẻo như Heo!';
